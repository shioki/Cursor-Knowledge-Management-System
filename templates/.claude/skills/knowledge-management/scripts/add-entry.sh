...
#
# Usage: bash .claude/skills/knowledge-management/scripts/add-entry.sh "判断タイトル"
#        （.cursor/skills にも対応）
#
# 引数:
#   $1 - 判断タイトル（必須）
...
KNOWLEDGE_FILE="${SKILL_BASE}/knowledge-management/references/KNOWLEDGE_TEMPLATE.md"
