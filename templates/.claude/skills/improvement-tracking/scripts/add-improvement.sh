...
#
# Usage: bash .claude/skills/improvement-tracking/scripts/add-improvement.sh "改善タイトル"
#        （.cursor/skills にも対応）
#
# 引数:
#   $1 - 改善タイトル（必須）
...
IMPROVEMENTS_FILE="${SKILL_BASE}/improvement-tracking/references/IMPROVEMENTS_TEMPLATE.md"
